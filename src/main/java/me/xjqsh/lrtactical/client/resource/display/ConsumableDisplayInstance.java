...
public class ConsumableDisplayInstance implements ICustomSoundSupplier {
    ...
    public static ConsumableDisplayInstance create(ConsumableDisplay pojo, ResourceLocation id) {
        ...
        display.texture = ResourceLocation.parse(pojo.textureLocation.getNamespace() + ":textures/" + pojo.textureLocation.getPath() + ".png");
        if (pojo.slotTextureLocation != null) {
            display.slotTexture = ResourceLocation.parse(pojo.slotTextureLocation.getNamespace() + ":textures/" + pojo.slotTextureLocation.getPath() + ".png");
        }
